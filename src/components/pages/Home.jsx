      ...
      <div className="flex-1 relative flex max-md:flex-col landscape:max-lg:flex-col">
        <div className="flex-1 flex">
          <div className="flex justify-center flex-col ml-5 md:ml-28 font-Varela">
            <h3 className="text-4xl max-sm:text-3xl md:text-7xl font-bold">Lets</h3>
            <h1 className="text-6xl max-sm:text-5xl md:text-9xl font-bold text-purple-600">
              E-learning
            </h1>
            <h2 className="text-5xl max-sm:text-4xl md:text-8xl font-bold">at your home</h2>
            ...
            <div className="flex justify-start border-black border space-x-10 items-center my-5">
              <button
